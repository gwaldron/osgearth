...
MACRO(LINK_CORELIB_DEFAULT CORELIB_NAME)
    IF(${ARGC} GREATER 1)
      LINK_EXTERNAL(${CORELIB_NAME} ${ARGN})
    ENDIF(${ARGC} GREATER 1)
    LINK_EXTERNAL(${CORELIB_NAME} ${OPENGL_LIBRARIES})
    LINK_WITH_VARIABLES(${CORELIB_NAME} OPENTHREADS_LIBRARY)
    IF(SEAMLESS_SONAMES)
      SET_TARGET_PROPERTIES(${CORELIB_NAME} PROPERTIES VERSION ${SEAMLESS_VERSION} SOVERSION ${SEAMLESS_SOVERSION})
    ENDIF(SEAMLESS_SONAMES)
