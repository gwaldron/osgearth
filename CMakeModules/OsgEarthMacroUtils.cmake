...
MACRO(LINK_CORELIB_DEFAULT CORELIB_NAME)
    ...
    IF(OSGEARTH_SONAMES)
      SET_TARGET_PROPERTIES(${CORELIB_NAME} PROPERTIES PREFIX "earth${OSGEARTH_MAJOR_VERSION}${OSGEARTH_MINOR_VERSION}-"  VERSION ${OSGEARTH_VERSION} SOVERSION ${OSGEARTH_SOVERSION})
...
MACRO(SET_OUTPUT_DIR_PROPERTY_260 TARGET_TARGETNAME RELATIVE_OUTDIR)
    ...
    FOREACH(CONF ${CMAKE_CONFIGURATION_TYPES})        # For each configuration (Debug, Release, MinSizeRel... and/or anything the user chooses)
        ...
        SET_TARGET_PROPERTIES(${TARGET_TARGETNAME} PROPERTIES "LIBRARY_OUTPUT_DIRECTORY_${CONF}" "${OUTPUT_LIBDIR}/${CONF}/${RELATIVE_OUTDIR}")		
...
# here we use the command to generate the library
    ...
    SET_OUTPUT_DIR_PROPERTY_260(${TARGET_TARGETNAME} "osgPlugins-${OPENSCENEGRAPH_VERSION}")
