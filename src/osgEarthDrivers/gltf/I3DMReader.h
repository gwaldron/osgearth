...
*/
#ifndef OSGEARTH_I3DM_READER_H
#define OSGEARTH_I3DM_READER_H
...
public:
    ...
    //! Read a I3DM file and return a node
    ...
    //! Read a I3DM data package and return a node.
    osg::Node* read(const std::string& location, const std::string& inputStream, const osgDB::Options* readOptions) const
    {
        ...
        if (magic != "i3dm")
        {
            ...
            if (compressor.valid())
            {
                ...
                {
                    OE_WARN << LC << "Invalid i3dm" << std::endl;
                    return NULL;
                }
        ...
        buf.read(reinterpret_cast<char*>(&header), sizeof(i3dmheader));
        bytesRead += sizeof(i3dmheader);
		...
		byteSwapInPlace(header.gltfFormat);
#endif
        ...
        fs.ExpandFilePath = &I3DMReader::ExpandFilePath;
