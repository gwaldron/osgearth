...
namespace
{
     ...
     */
    struct ReadImageFromCachePseudoLoader : public osgDB::ReaderWriter
    {
        ReadImageFromCachePseudoLoader() {
    ...
    REGISTER_OSGPLUGIN(osgearth_cachebin, ReadImageFromCachePseudoLoader);
}
