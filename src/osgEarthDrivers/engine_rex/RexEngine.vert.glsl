...
#pragma vp_entryPoint oe_rexEngine_init_model
...
void oe_rexEngine_init_model(inout vec4 vertexModel)
{
...
#pragma vp_entryPoint oe_rexEngine_init_view
...
void oe_rexEngine_init_view(inout vec4 vertexView)
{
