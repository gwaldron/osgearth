...
// statset defines
#pragma import_defines(OE_PROCEDURAL_NOISE_SAMPLER)
#pragma import_defines(OE_PROCEDURAL_EDIT_MODE)
#pragma import_defines(OE_PROCEDURAL_GPU_NOISE)
#pragma import_defines(OE_TERRAIN_RENDER_NORMAL_MAP)
#pragma import_defines(OE_TERRAIN_BLEND_IMAGERY)
#pragma import_defines(OE_PROCEDURAL_USE_MATERIALS)
...
#ifdef OE_PROCEDURAL_USE_MATERIALS
...
#ifdef OE_PROCEDURAL_NOISE_SAMPLER
uniform sampler2D OE_PROCEDURAL_NOISE_SAMPLER;
vec4 oe_splat_getNoise(in vec2 tc)
{
    return texture(OE_PROCEDURAL_NOISE_SAMPLER, tc.st);
}
#else
vec4 oe_splat_getNoise(in vec2 tc)
{
