...
ExtrudeGeometryTexArrayFilter::ExtrudeGeometryTexArrayFilter() :
_maxAngle_deg       ( 5.0 ),
_mergeGeometry      ( true ),
...
void
ExtrudeGeometryTexArrayFilter::setStyle( const Style& style )
{
    _style      = style;
    _styleDirty = true;
}
...
void
ExtrudeGeometryTexArrayFilter::reset( const FilterContext& context )
{
...
bool
ExtrudeGeometryTexArrayFilter::extrudeGeometry(const Geometry*         input,
                                       double                  height,
                                       double                  heightOffset,
                                       bool                    flatten,
                                       osg::Geometry*          walls,
...
void
ExtrudeGeometryTexArrayFilter::addDrawable(osg::Drawable*      drawable,
...
bool
ExtrudeGeometryTexArrayFilter::process( FeatureList& features, FilterContext& context )
{
...
osg::Node*
ExtrudeGeometryTexArrayFilter::push( FeatureList& input, FilterContext& context )
{
    reset( context );
