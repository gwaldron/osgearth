...
FIND_LIBRARY(${MYLIBRARY}
    NAMES
        ${MYLIBRARYNAME} ${MYLIBRARYNAME}d ${MYLIBRARYNAME}rd
    PATHS
        ${OSG_DIR}
        $ENV{OSG_BUILD_DIR}
        $ENV{OSG_DIR}
...
IF(OPENSCENEGRAPH_VERSION VERSION_LESS "3.5.6")
  ...
  FIND_OSG_LIBRARY( OSGQT_LIBRARY_RELWITHDEBINFO osgQtrd)
ELSE(OPENSCENEGRAPH_VERSION VERSION_LESS "3.5.6")
  IF(Qt5Widgets_FOUND)
    ...
    FIND_OSG_LIBRARY( OSGQT_LIBRARY_RELWITHDEBINFO osgQt5rd)
...
FIND_OSG_LIBRARY( OPENTHREADS_LIBRARY_RELWITHDEBINFO OpenThreadsrd)
