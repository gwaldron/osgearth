...
OE_PROPERTY_IMPL(TerrainOptionsAPI, unsigned, MinResidentTiles, minResidentTiles);
...
OE_PROPERTY_IMPL(TerrainOptionsAPI, float, ScreenSpaceError, screenSpaceError);
