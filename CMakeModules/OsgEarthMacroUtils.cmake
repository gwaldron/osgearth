...
MACRO(LINK_CORELIB_DEFAULT CORELIB_NAME)
    ...
    IF(OSGEARTH_SONAMES)
      ...
      if(WIN32 AND NOT MSVC)
          SET_TARGET_PROPERTIES(${CORELIB_NAME} PROPERTIES SUFFIX -${OSGEARTH_SOVERSION}${CMAKE_SHARED_LIBRARY_SUFFIX})
      endif()
...
# here we use the command to generate the library
    ...
    IF(UNIX)
        SET_TARGET_PROPERTIES(${TARGET_TARGETNAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY "${LIBRARY_OUTPUT_PATH}/${OSG_PLUGINS}")
    ENDIF()
...
#the installation path are differentiated for win32 that install in bib versus other architecture that install in lib${LIB_POSTFIX}/${VPB_PLUGINS}
    IF(WIN32)
        ...
        IF(MSVC AND NOT CMAKE_BUILD_TYPE STREQUAL "Release")
            GET_TARGET_PROPERTY(POSTFIX ${TARGET_TARGETNAME} DEBUG_POSTFIX)
            INSTALL(FILES ${LIBRARY_OUTPUT_PATH}/${TARGET_TARGETNAME}${POSTFIX}.pdb DESTINATION bin COMPONENT ${PACKAGE_COMPONENT})
        ENDIF()
