...
#pragma vp_entryPoint "oe_NormalMap_vertex"
...
out vec2 oe_NormalMap_coords;
flat out mat3 oe_NormalMap_TBN;

void oe_NormalMap_vertex(inout vec4 unused)
{
    // calculate the sampling coordinates for the normal texture
    oe_NormalMap_coords = (oe_tile_normalTexMatrix * oe_layer_tilec).st;
    ...
    oe_NormalMap_TBN = mat3(T, B, vp_Normal);
}
