...
namespace
{
    ...
    FileSystemCacheBin::readImage(const std::string& key, const osgDB::Options* readOptions)
    {
        ...
        // lock the file:
        ScopedGate<std::string> gate(_fileGate, fileURI.full());
    ...
    namespace
    {
        ...
        public:
            ...
            void operator()(osg::Object*) override
            {
                ...
                Threading::ScopedGate<std::string> gate(_bin->_fileGate, _uri.full());
    ...
    FileSystemCacheBin::remove(const std::string& key)
    {
        ...
        Threading::ScopedGate<std::string> gate(_fileGate, fileURI.full());
